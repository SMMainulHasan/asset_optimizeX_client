  ...
  return (
    <div className="bg-gray-900 text-gray-400 py-10 sm:px-6 lg:px-40 ">
      ...
      <ul className="list-disc list-inside text-lg mb-8">
        ...
        <li>
          <span className="font-bold">Ease of Use:</span> Asset OptimizeX is designed to be intuitive and user-friendly. No steep learning curves - just efficient asset management from day one.
        </li>
        <li>
          <span className="font-bold">Security:</span> We prioritize the security of your assets, implementing robust safeguards to protect your digital resources.
        </li>
        <li>
          <span className="font-bold">Scalability:</span> Whether you&apos;re a small startup or a large enterprise, Asset OptimizeX scales with you. Grow without limitations.
        </li>
        <li>
          <span className="font-bold">Collaboration:</span> We facilitate seamless collaboration within your teams. Share, edit, and work together without missing a beat.
        </li>
      </ul>
